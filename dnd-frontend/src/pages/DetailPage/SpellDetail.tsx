...
export const SpellDetail: React.FC<{ data: any }> = ({ data }) => {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h4 className="text-[#FFFBE4] text-[20px] font-bold mb-2">School & Level</h4>
        <p className="opacity-90">{data.school?.name || data.school} • Level: {data.level}</p>
      </div>

      <div>
        <h4 className="text-[#FFFBE4] text-[20px] font-bold mb-2">Casting</h4>
      ...
      <div>
        <h4 className="text-[#FFFBE4] text-[20px] font-bold mb-2">Description</h4>
